...
{ before(grammarAccess.getSodaAccess().getPollsPollParserRuleCall_0()); }
	rulePoll{ after(grammarAccess.getSodaAccess().getPollsPollParserRuleCall_0()); }
)
...
{ before(grammarAccess.getQuestionAccess().getQuerySTRINGTerminalRuleCall_3_0()); }
	RULE_STRING{ after(grammarAccess.getQuestionAccess().getQuerySTRINGTerminalRuleCall_3_0()); }
)
...
{ before(grammarAccess.getOptionAccess().getReponseSTRINGTerminalRuleCall_1_0()); }
	RULE_STRING{ after(grammarAccess.getOptionAccess().getReponseSTRINGTerminalRuleCall_1_0()); }
)
