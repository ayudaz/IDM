...
public class WidgetImpl extends MinimalEObjectImpl.Container implements Widget {
	...
	protected EClass eStaticClass() {
		return MMUIPackage.Literals.WIDGET;
	}
	...
	public void setWidth(int newWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MMUIPackage.WIDGET__WIDTH, oldWidth, width));
	}
	...
	public void setLength(int newLength) {
		...
		length = newLength;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MMUIPackage.WIDGET__LENGTH, oldLength, length));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MMUIPackage.WIDGET__WIDTH:
				return getWidth();
