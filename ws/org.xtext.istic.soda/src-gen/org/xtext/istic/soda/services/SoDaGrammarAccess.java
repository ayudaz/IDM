...
* generated by Xtext
*/
package org.xtext.istic.soda.services;
...
@Singleton
public class SoDaGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class SodaElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Soda");
	...
	public class QuestionElements extends AbstractParserRuleElementFinder {
		...
		//Question:
		//	"Question" name=ID? "{" query=STRING "options" options+=Option+ "}";
		public ParserRule getRule() { return rule; }
	...
	public class OptionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cReponseAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cReponseSTRINGTerminalRuleCall_1_0 = (RuleCall)cReponseAssignment_1.eContents().get(0);
		...
		//reponse=STRING
		public Assignment getReponseAssignment_1() { return cReponseAssignment_1; }

		//STRING
		public RuleCall getReponseSTRINGTerminalRuleCall_1_0() { return cReponseSTRINGTerminalRuleCall_1_0; }
	}
	
	
	private SodaElements pSoda;
	private PollElements pPoll;
	...
	@Inject
	public SoDaGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.istic.soda.SoDa".equals(grammar.getName())) {
				return grammar;
			}
	...
	//Soda:
	//	polls+=Poll*;
	public SodaElements getSodaAccess() {
		return (pSoda != null) ? pSoda : (pSoda = new SodaElements());
	}
	
	public ParserRule getSodaRule() {
		return getSodaAccess().getRule();
	}

	//Poll:
	//	"Poll" name=ID? "{" questions+=Question+ "}";
	public PollElements getPollAccess() {
		return (pPoll != null) ? pPoll : (pPoll = new PollElements());
	}
